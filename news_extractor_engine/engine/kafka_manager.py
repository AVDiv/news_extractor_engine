...
class KafkaProducerManager:
    ...
    # Kafka configuration
    __KAFKA_BOOTSTRAP_SERVERS: str = os.getenv(
    ...
    __KAFKA_PRODUCER_TOPIC: str = os.getenv("KAFKA_PRODUCER_TOPIC")
    __KAFKA_CONFIG: Dict[str, Any] = {
        "bootstrap.servers": __KAFKA_BOOTSTRAP_SERVERS,
        "client.id": __KAFKA_CLIENT_ID_PREFIX,
    }
